import{a as t,r as o,R as N,f as A,g as y,j as f}from"./vendor-1e2286d0.js";import{L as x,_ as P,f as E,c as D}from"./index-8cf2cb33.js";const O=N.lazy(()=>P(()=>import("./Portfolio-1e1bd5e6.js"),["js/Portfolio-1e1bd5e6.js","js/vendor-1e2286d0.js","js/index-8cf2cb33.js","css/index-a208ebf2.css"]));function F({imageCollection:m}){return t("ul",{className:"tw-flex tw-flex-wrap tw-justify-between",children:m.map((l,r)=>t(o.exports.Suspense,{fallback:t("li",{children:t(x,{})}),children:t(O,{item:l,index:r})},r))})}function b(){const m=A(e=>e.portfolio.images),l=y(),r=o.exports.useRef(),p=o.exports.useRef(),d={VITE_CONTENTFUL_SPACE_ID:"bydtte43696p",VITE_CONTENTFUL_DELIVERY_API_ACCESS_TOKEN:"o_0M11CmFcIeL6DYMznuZfs1JS-ptr6FDdSwTP7p7SY",BASE_URL:"/",MODE:"production",DEV:!1,PROD:!0},S=d.VITE_CONTENTFUL_SPACE_ID,T=d.VITE_CONTENTFUL_DELIVERY_API_ACCESS_TOKEN,w=`
	query imagesAssets {
		imageCollection{
			items{
				image{
...
//# sourceMappingURL=PortfolioForm-31796478.js.map
