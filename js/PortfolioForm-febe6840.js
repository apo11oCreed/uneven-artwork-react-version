import{a,r,R as A,f as v,g as y,j as g}from"./vendor-1e2286d0.js";import{L as x,_ as P,f as _,c as D}from"./index-7cdbe374.js";const M=A.lazy(()=>P(()=>import("./Portfolio-c5b8774b.js"),["js/Portfolio-c5b8774b.js","js/vendor-1e2286d0.js","js/index-7cdbe374.js","css/index-a208ebf2.css"]));function O({imageCollection:c}){return a("ul",{className:"tw-flex tw-flex-wrap tw-justify-between",children:c.map((o,s)=>a(r.exports.Suspense,{fallback:a("li",{children:a(x,{})}),children:a(M,{item:o,index:s})},s))})}function b(){const c=v(e=>e.portfolio.images),o=y(),s=r.exports.useRef(),f=r.exports.useRef(),d={VITE_CONTENTFUL_SPACE_ID:"bydtte43696p",VITE_CONTENTFUL_DELIVERY_API_ACCESS_TOKEN:"o_0M11CmFcIeL6DYMznuZfs1JS-ptr6FDdSwTP7p7SY",BASE_URL:"/",MODE:"production",DEV:!1,PROD:!0},E=d.VITE_CONTENTFUL_SPACE_ID,S=d.VITE_CONTENTFUL_DELIVERY_API_ACCESS_TOKEN,T=`
	query imagesAssets {
		imageCollection{
			items{
				image{
...
//# sourceMappingURL=PortfolioForm-febe6840.js.map
