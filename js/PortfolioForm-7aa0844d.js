import{a,r,R as N,f as v,g as y,j as g}from"./vendor-1e2286d0.js";import{L as x,_ as P,f as _,c as D}from"./index-23917026.js";const M=N.lazy(()=>P(()=>import("./Portfolio-7fe88c6f.js"),["js/Portfolio-7fe88c6f.js","js/vendor-1e2286d0.js","js/index-23917026.js","css/index-bb5419b0.css"]));function O({imageCollection:c}){return a("ul",{className:"tw-flex tw-flex-wrap tw-justify-between",children:c.map((o,s)=>a(r.exports.Suspense,{fallback:a(x,{}),children:a(M,{item:o,index:s})},s))})}function b(){const c=v(e=>e.portfolio.images),o=y(),s=r.exports.useRef(),f=r.exports.useRef(),p={VITE_CONTENTFUL_SPACE_ID:"bydtte43696p",VITE_CONTENTFUL_DELIVERY_API_ACCESS_TOKEN:"o_0M11CmFcIeL6DYMznuZfs1JS-ptr6FDdSwTP7p7SY",BASE_URL:"/",MODE:"production",DEV:!1,PROD:!0},E=p.VITE_CONTENTFUL_SPACE_ID,S=p.VITE_CONTENTFUL_DELIVERY_API_ACCESS_TOKEN,T=`
	query imagesAssets {
		imageCollection{
			items{
				image{
...
//# sourceMappingURL=PortfolioForm-7aa0844d.js.map
