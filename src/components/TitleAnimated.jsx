...
export default function TitleAnimated({siteName}) {
	...
	return (
		<div id='titleAnimate' ref={titleRef} className='tw-text-black tw-font-bold tw-mx-0.5 tw-text-center tw-absolute tw-left-1/2 tw-whitespace-nowrap -tw-translate-x-1/2 md:tw-tracking-[1vw] tw-text-[7vw] md:tw-text-[7.2rem] tw-leading-none'>
			{siteName}
